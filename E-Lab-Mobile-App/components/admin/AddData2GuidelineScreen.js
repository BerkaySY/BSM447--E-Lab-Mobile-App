...
const AddData2GuidelineScreen = () => {
  ...
  const [intervalType, setIntervalType] = useState('gün'); // Default to 'gün'
        ...
        <KeyboardAvoidingView style={{ flex: 1 }} behavior="padding">
          <ScrollView contentContainerStyle={styles.contentContainer}>
            <View style={[styles.card, isDarkMode && styles.cardDark]}>
              ...
              <Text style={[styles.label, isDarkMode && styles.darkText]}>Yaş Aralığı Türü</Text>
              <View style={[styles.pickerContainer, isDarkMode && styles.pickerDark]}>
                ...
                >
                  ...
                  <Picker.Item label="Yıl" value="yıl" />
                </Picker>
              </View>
              ...
              <Text style={[styles.label, isDarkMode && styles.darkText]}>Geometrik Ortalama</Text>
              <TextInput
                style={[styles.input, isDarkMode && styles.inputDark]}
                value={geometricMean}
              ...
              <Text style={[styles.label, isDarkMode && styles.darkText]}>Ortalama</Text>
              <TextInput
                style={[styles.input, isDarkMode && styles.inputDark]}
              ...
              <Text style={[styles.label, isDarkMode && styles.darkText]}>Standart Sapma</Text>
              <TextInput
                style={[styles.input, isDarkMode && styles.inputDark]}
              ...
              <Text style={[styles.label, isDarkMode && styles.darkText]}>%95 Güven Aralığı Min</Text>
              <TextInput
                style={[styles.input, isDarkMode && styles.inputDark]}
              ...
              <Text style={[styles.label, isDarkMode && styles.darkText]}>%95 Güven Aralığı Max</Text>
              <TextInput
                style={[styles.input, isDarkMode && styles.inputDark]}
...
export default AddData2GuidelineScreen;